...
"%SEVEN_ZIP%" a -t7z "%ARCHIVE_PATH%" "." ^
    -mx=7 -m0=lzma2 ^
    -xr!build -xr!dist -xr!dist-appimage -xr!dist-deb -xr!dist-source -xr!dist-windows -xr!Toolbox.AppDir -xr!thirdparty -xr!.bin ^
